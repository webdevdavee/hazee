        ...
        >
          <div className="overflow-hidden">
            <motion.h1
              ...
              className="text-6xl font-bold mb-4 text-zinc-100 leading-tight m:text-4xl m:mb-0"
            >
              Unleash the Power
              <br />
          ...
          <p className="text-zinc-400 text-lg mb-8 leading-relaxed m:text-sm">
          ...
          <div className="flex space-x-6 m:space-x-0 m:flex-col m:gap-6">
            <Link
              href="/explore/collections"
              className="group flex items-center gap-3 px-8 py-3 bg-zinc-700 hover:bg-accent rounded-full text-white hover:text-background_light transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl m:justify-center"
            >
