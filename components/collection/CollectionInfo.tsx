...
const CollectionInfo: React.FC<Props> = ({ collection, creator }) => {
  ...
  return (
    <div className="flex justify-between m:flex-col m:gap-4">
      <div className="w-[60%] flex flex-col gap-3 m:gap-6 m:w-full xl:w-[60%]">
      ...
      <div className="w-[25%] h-fit rounded-2xl border border-secondary p-4 border-opacity-50 m:w-full xl:w-[40%]">
